...
def main_menu():
    while True:
        ...
        #MAIN MENU 7  
            ...
            while True:
                ...
                if choice == '1':
                    ...
                    print("\t\t\t\tEXAMPLE\t\t\t\t\n")  
                    print("============================================================================")
                    type_print("\n# Function without parameters", 0.05)
                    time.sleep(0.5)
                    print("def greet():")
                    print("    print(\"Hello!\")")
        ...
        #MAIN MENU 8
            ...
            os.system('cls')
            while True:
                type_print(f"Hi, {name}. Welcome to the PYTHON QUIZ! \nYou may choose difficulty.", 0.05)
                time.sleep(0.5)
                print("==========================")
                print("=======PYTHON QUIZ========")
                print("==========================")
                ...
                #EASY QUESTIONS
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• print() is the built-in Python function used to display text, numbers, or results on the screen. \n• echo() and say() are not Python functions.")
                    print("\n============================================================================")

                    #Q2
                    type_print("\n2. What symbol is used for addition?")
                    time.sleep(0.5)
                    print("a. +")
                    print("b. -")
                    print("c. *")
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• A variable cannot start with a number or contain special characters like @. \n• 2name is invalid because variables cannot start with digits. \n• @hello is invalid because special characters are not allowed. \n• name is valid because it starts with a letter and contains only letters.")
                    print("\n============================================================================")
                ...
                if difficulty == "2":
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• pop() removes the last item by default. \n• remove() deletes a specific value, NOT the last one. \n• delete() does NOT exist in Python lists.")
                    print("\n============================================================================")
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• The list has two elements: \n1. \'A\' \n2. [\'B\', \'C\'] → this is one item, even if it contains two things. \n• So the length is: 2, not 3.")
                    print("\n============================================================================")
                ...
                if difficulty == "3":
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• When you multiply a string by a number, Python repeats the string. \n• \'2\' repeated 3 times becomes: \n• \"222\" \nNot 6, because \'2\' is not a number — it's text.")
                    print("\n============================================================================")
                    ...
                    print("c. bool('False')")
                    ans = input("Your answer: ").lower()
                    if ans == "c":   # non-empty strings are True
                        print("Correct!")
                        score += 1
                        correct_ans += 1
                    else: 
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• In Python, any non-empty string is True, even if the text says \"False\". \n• bool(\"False\") = True \n• 10 == '10' is False because string ≠ integer. \n• [] == False is False because empty list ≠ Boolean False. ")
                    print("\n============================================================================")
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• Python reads code top to bottom. \n• If you call a function before Python sees its definition, it has no idea what the function is. \n• So it throws a: \n• NameError: name 'function_name' is not defined")
                    print("\n============================================================================")
                    ...
                    print("============================================================================")
                    print("\nExplanation: \n• {} is the literal syntax for an empty dictionary. \n• Empty sets use set(), not {}. \n• Tuples use (). \n• Therefore: \n• type({}) = dict")
                    print("\n============================================================================")
