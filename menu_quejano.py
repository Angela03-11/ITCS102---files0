    ...
    while True:
        ...
        #MAIN MENU 8
            ...
            while True:
                ...
                print(f"Hi, {name}. YOU CHOSE {quiz_name} QUIZ! Best of luck!\n")
                ...
                if choice == "1":
                    print("1. What function prints output in Python?")
                    print("a. echo()")
                    print("b. print()")
                    print("c. say()")
                    ...
                    print("\n============================================================================")
                    print(f"QUIZ FINISHED! Your Score: {score}/{total_q}")
                    print("============================================================================")
                    choice = input("\nEnter (0) to return:")
                ...
                # MEDIUM QUESTIONS
                if choice == "2":
                    print("1. What does this expression return?  10 > 5 and 5 > 2")
                    print("a. True")
                    print("b. False")
                    print("c. Error")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n2. What is the correct way to remove the LAST item in a list?")
                    print("a. list.delete()")
                    print("b. list.remove()")
                    print("c. list.pop()")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n4. What keyword allows a loop to skip the current iteration?")
                    print("a. break")
                    print("b. continue")
                    print("c. skip")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n5. What will be the OUTPUT of:  len(['A', ['B', 'C']])")
                    print("a. 3")
                    print("b. 2")
                    print("c. 1")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n============================================================================")
                    print(f"{quiz_name} QUIZ FINISHED! Your Score: {score}/{total_q}")
                    print("============================================================================")
                    input("\nEnter (0) to return:")
                    os.system("cls")
                ...
                # HARD QUESTIONS
                if choice == "3":
                    print("1. What is the output?  print( 3 * '2' )")
                    print("a. 222")
                    print("b. 6")
                    print("c. Error")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n2. Which expression will return \"True\"?")
                    print("a. 10 == '10'")
                    print("b. [] == False")
                    print("c. bool('False')")
                    ans = input("Your answer: ").lower()
                    ...
                    print("\n3. What happens if you call a function before defining it?")
                    ...
                    print("\n4. What does this return?  [1, 2, 3][1]")
                    print("a. 1")
                    print("b. 2")
                    print("c. 3")
                    ans = input("Your answer: ").lower()
